...
class Options():
    def __init__(self):
        ...
        'rain', 'sunset'])
        parser.add_argument('--kitti_eigen_split_file', type=str, default='dataset/kitti_eigen_test_split.txt')
        parser.add_argument('--cat_txt_files_root', type=str, default='dataset/kitti_cat_classification/')
