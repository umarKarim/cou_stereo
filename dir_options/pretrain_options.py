...
class Options():
    def __init__(self):
        ...
        parser.add_argument('--kitti_eigen_split_file', type=str, default='/hdd/local/sdb/umar/codes/continual_stereo/dir_dataset/kitti_eigen_test_split.txt')
        ...
        parser.add_argument('--save_model_dir', type=str, default='trained_models/pretrain_models/')
