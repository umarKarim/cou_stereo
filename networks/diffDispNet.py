...
class DispNet(nn.Module):
    ...
    def forward(self, input_image1, input_image2):
        features = self.encoder(input_image1, input_image2)
...
if __name__ == '__main__':
    in_image1 = torch.rand((4, 3, 256, 320))
    in_image2 = torch.rand((4, 3, 256, 320))
    depth_net = DispNet()
    disp = depth_net(in_image1, in_image2)
    print(disp.size())
